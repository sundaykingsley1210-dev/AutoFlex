...
const seedData = async () => {
  try {
    ...
    const demoPayments = await Payment.insertMany([
      { user: customers[0]._id, application: demoApplications[0]._id, vehicle: vehicles[0]._id, amount: 5250, type: 'deposit', transactionRef: 'AFX-DEPOSIT-001', status: 'successful', paymentMethod: 'bank_transfer' },
      { user: customers[0]._id, application: demoApplications[0]._id, vehicle: vehicles[0]._id, amount: 847, type: 'installment', transactionRef: 'AFX-INST-001', status: 'successful', paymentMethod: 'monniepay' },
      { user: customers[0]._id, application: demoApplications[0]._id, vehicle: vehicles[0]._id, amount: 847, type: 'installment', transactionRef: 'AFX-INST-002', status: 'successful', paymentMethod: 'monniepay' },
      { user: customers[0]._id, application: demoApplications[0]._id, vehicle: vehicles[0]._id, amount: 847, type: 'installment', transactionRef: 'AFX-INST-003', status: 'successful', paymentMethod: 'monniepay' },
      { user: customers[1]._id, application: demoApplications[1]._id, vehicle: vehicles[2]._id, amount: 6750, type: 'deposit', transactionRef: 'AFX-DEPOSIT-002', status: 'successful', paymentMethod: 'bank_transfer' },
      { user: customers[3]._id, application: demoApplications[3]._id, vehicle: vehicles[10]._id, amount: 6300, type: 'deposit', transactionRef: 'AFX-DEPOSIT-003', status: 'successful', paymentMethod: 'bank_transfer' },
      { user: customers[3]._id, application: demoApplications[3]._id, vehicle: vehicles[10]._id, amount: 1017, type: 'installment', transactionRef: 'AFX-INST-004', status: 'successful', paymentMethod: 'monniepay' },
      { user: customers[3]._id, application: demoApplications[3]._id, vehicle: vehicles[10]._id, amount: 1017, type: 'installment', transactionRef: 'AFX-INST-005', status: 'successful', paymentMethod: 'monniepay' }
    ]);
    ...
    for (let i = 1; i <= 36; i++) {
      ...
      schedulePayments1.push({
        paymentNumber: i,
        dueDate,
        amountDue: i === 36 ? 35000 - 5250 - (847 * 35) : 847,
        amountPaid: isPaid ? (i === 36 ? 35000 - 5250 - (847 * 35) : 847) : 0,
    ...
    for (let i = 1; i <= 36; i++) {
      ...
      schedulePayments2.push({
        paymentNumber: i,
        dueDate,
        amountDue: i === 36 ? 42000 - 6300 - (1017 * 35) : 1017,
        amountPaid: isPaid ? (i === 36 ? 42000 - 6300 - (1017 * 35) : 1017) : 0,
    ...
    await Notification.insertMany([
      { user: customers[0]._id, type: 'payment_received', message: 'Payment of $5,250 received successfully.', isRead: true, link: '/payments' },
      { user: customers[0]._id, type: 'payment_due', message: 'Your next installment of $847 is due soon.', isRead: false, link: '/schedule' },
